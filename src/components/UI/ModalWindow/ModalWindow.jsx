...
const ModaWindow = ({ setShowModal, resetAllCharacters }) => {
   ...
   if (modalOpenValue) {
      return ReaсtDOM.createPortal(
         <CSSTransition classNames="modal__window__animation" in={true} appear={true} timeout={200}>
            <div className="modal__wrapper" onClick={() => closeModal()}>
               <div className="modal__content" onClick={(e) => e.stopPropagation()}>
                  ...
                  <p className="modal__body">
                     The entire grid of characters that is currently available on the site will be reset. After the reset, <span>9</span>{" "}
                     new characters will be loaded from the server.
                  </p>
